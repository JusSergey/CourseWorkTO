...
struct SocketFD {
    ...
    SocketFD(int fd = (int)SocketStatus::Invalid) : _fd(fd) {}
    ...
    inline bool isValid() const { return *this != SocketStatus::Invalid; }
    inline void setValidFalse() { _fd = static_cast<std::underlying_type<SocketStatus>::type>(SocketStatus::Invalid); }
